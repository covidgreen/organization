...
| `@covidgreen/core`  |  Core development  |  `organization` |
...
1. Open a pull request to [`covidgreen/organization:current`](https://github.com/covidgreen/organization/pulls) that adds your name, username, and email to the team you have choosen in the [README.md](./README.md). The members lists are sorted alphabetically; make sure to add your name in the proper order.
...
1. If the collaborator can't work with us anymore, they should:
  1. Open a pull request to [`covidgreen/organization:current`](https://github.com/covidgreen/organization/pulls) and move themselves in the *Past Collaborators* section.
